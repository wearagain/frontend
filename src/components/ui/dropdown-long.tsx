  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "bg-popover text-popover-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 max-h-(--radix-dropdown-menu-content-available-height) min-w-[8rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-md border p-1 shadow-md w-[var(--radix-popper-anchor-width)]",
          " rounded-[6px] py-[10px] bg-white border border-[#E0E2E4]",
          "custom-scroll",
          className
        )}
        {...props}
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "px-3 focus:bg-accent focus:text-accent-foreground focus:mx-3 focus:px-0",
        className
      )}
      {...props}
    />
...
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn("bg-border mx-4 h-px", "bg-[#E0E2E4] my-0", className)}
      {...props}
    />
  );
}
